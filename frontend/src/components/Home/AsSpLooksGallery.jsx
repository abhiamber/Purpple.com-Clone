      ...
      >
        <Box>
          <Image
            w="630px"
            h={["250px", "350px", "450px"]}
            src="https://media6.ppl-media.com/tr:w-640,ar-320-229,c-at_max,pr-true,dpr-2,f-gif/mediafiles/ecomm/misc/1674046022_slicebannerweb_01-1.gif"
          />
        </Box>
        <Box>
          <Image
            w="630px"
            h={["250px", "350px", "450px"]}
            src="https://media6.ppl-media.com/tr:w-640,ar-320-229,c-at_max,pr-true,dpr-2,f-gif/mediafiles/ecomm/misc/1674046021_slicebannerweb_02-1.gif"
          />
        </Box>
      </SimpleGrid>
    </>
