...
export default function AsFrGift() {
  ...
  return (
    <>
      <Box mt="40px">
        <Image w="1256px" h={["28px","38px","98px"]} m="auto" src="https://media6.ppl-media.com/tr:w-1280,c-at_max,pr-true,dpr-2,f-gif/mediafiles/ecomm/misc/1673939614_get-free-gifts-web.gif" />
      </Box>
      ...
      <SimpleGrid columns={[1,1,2]} pl={[null,null,"120px"]} pr={[null,null,"120px"]} mt="60px">
        <Box>
          <Image
            w="635px"
            h={["210px","310px","310px"]}
