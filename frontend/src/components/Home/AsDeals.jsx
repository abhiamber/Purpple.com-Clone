...
export default function AsDeals() {
  ...
  return (
    <>
      <Box mt="60px">
        <Image w="1260px" h={["120px","167px","267px"]} m="auto" src="https://media6.ppl-media.com/tr:w-1280,c-at_max,pr-true,dpr-2,f-gif/mediafiles/ecomm/misc/1674099518_mamaearth_web_thick-strip.gif" />
      </Box>
      <Box mt="60px">
        <Image w="1256px" h={["28px","38px","98px"]} m="auto" src="https://media6.ppl-media.com/tr:w-1280,c-at_max,pr-true,dpr-2,f-gif/mediafiles/ecomm/misc/1673939041_unmissable-deals_web_10.gif" />
      </Box>
      <Box mt="40px" pl={[null,null,"120px"]} pr={[null,null,"120px"]}>
        <Slider {...settings}>
          <Box>
            <Image
              w="250px"
