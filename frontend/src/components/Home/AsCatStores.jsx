  ...
  return (
    <>
      <Box pl="120px" pr="120px" mt="40px">
        <Heading as="h1" fontSize="22px" letterSpacing="2px" textAlign={["center","center","left"]}>
          CATEGORY STORES
        </Heading>
      </Box>
      <Box mt="50px" pl={[null,null,"120px"]} pr={[null,null,"120px"]}>
        <Slider {...settings}>
          <Box>
            <Image
              w="250px"
      ...
      <Box mt="60px"  >
        <Image w="1256px" h={["38px","48px","98px"]} m="auto" src="https://media6.ppl-media.com/tr:w-1280,c-at_max,pr-true,dpr-2,f-gif/mediafiles/ecomm/misc/1674026919_reminder-elite-1280x100.gif" />
      </Box>
    </>
  );
}
